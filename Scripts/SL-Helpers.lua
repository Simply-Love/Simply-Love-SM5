...
function GetPlayerOptions2LineNames()
	local mods = "Turn,Scroll,7,8,9,10,11,12,13,Attacks,Hide,ReceptorArrowsPosition,LifeMeterType,DataVisualizations,TargetScore,ActionOnMissedTarget,GameplayExtras,MeasureCounterPosition,MeasureCounter,StaminaFeatures,DecentsWayOffs,Vocalization,Characters,ScreenAfterPlayerOptions2"
