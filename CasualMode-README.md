...
Casual Mode provides a simplified experience intended to address stumbling points novice players commonly have when playing StepMania on arcade hardware.  To summarize, it:
  ...
  * provides more prominent onscreen instructions throughout
...
If no groups are specified in this file (i.e., if the file is empty), all packs with valid stepcharts will be available for play in Casual Mode.
