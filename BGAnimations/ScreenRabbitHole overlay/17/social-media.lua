...
local af = Def.ActorFrame{
	...
	Def.BitmapText{
		File=THEME:GetPathB("ScreenRabbitHole", "overlay/_shared/helvetica neue/_helvetica neue 20px.ini"),
		Text="...And so, suddenly, after nearly five years of only emails and instant messages, we were able to Skype because the state of technology permitted it, and I had a voice and face to associate with a personalty.  Our friendship expanded into new dimensions at that moment.\n\nIt strikes me now, years later, how patient we were, having exchanged words over the internet for years without ever asking to see or hear the person on the other end.  These days, people get angry with you for not having an OkCupid photo demonstrably revealing your cup size.\n\n\"Were you instantly smitten by her beauty, being finally able to see her?\"\n\nI don't know.  I didn't really think of it like that at the time, because I'd already been smitten by her words long before that.  She'd demonstrated an utterly captivating command of language from the start, able to be playful and witty and deeply incisive all at once in a single sentence.  I swear, her words kept me alive some nights.",
		InitCommand=function(self) self:diffuse(0.25,0.25,0.25,1):align(0,0):xy(_screen.cx-post.w/2 + post.padding/2, 100):zoom(0.65):wrapwidthpixels((post.w - post.padding*2)/0.65) end
	},
