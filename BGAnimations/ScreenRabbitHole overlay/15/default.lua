...
af[#af+1] = LoadActor("./blog.lua", scene1)..{
...
-- scene 2: I had another dream about her last night
...
-- scene 3: what if nothing good were to come?
af[#af+1] = LoadActor( THEME:GetPathB("ScreenRabbitHole", "overlay/14/im-window.lua"), scene3 )..{
	InitCommand=function(self)
		scenes[3] = self
		self:visible(false)
	end,
...
-- scene 4: I'm interested in learning about you
