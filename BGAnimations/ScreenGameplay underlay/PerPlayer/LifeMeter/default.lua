...
-- in Competitive, ECFA and Expert, we have the choice a "Standard" LifeMeter (at the top of the screen)
-- or a "Surround" LifeMeter, which is like the StomperZ surround LifeMeter but more drab.
elseif SL.Global.GameMode == "Competitive" or SL.Global.GameMode == "ECFA" or SL.Global.GameMode == "Expert" then
