...
return LoadFont("_miso")..{
	...
	SwitchFocusToGroupsMessageCommand=function(self)
		self:diffusealpha(0):settext(THEME:GetString("ScreenSelectMusicCasual", "FooterTextGroups")):linear(0.3):diffusealpha(1)
	end,
	SwitchFocusToSongsMessageCommand=function(self)
		self:diffusealpha(0):settext(THEME:GetString("ScreenSelectMusicCasual", "FooterTextSongs")):linear(0.3):diffusealpha(1)
	end,
	SwitchFocusToSingleSongMessageCommand=function(self)
		self:diffusealpha(0):settext( cancel ):linear(0.3):diffusealpha(1)
	end,
}