...
local CurrentLowerDifficulty = 0
local CurrentUpperDifficulty = 0
local CurrentLowerBPM = 49
local CurrentUpperBPM = 49
local CurrentLowerLength = 0
local CurrentUpperLength = 0
...
local function SetMainSortPreference(value)
...
local function SetSubSortPreference(value)
	for i,playerNum in ipairs(GAMESTATE:GetHumanPlayers()) do
...
local function GetLowerDifficultyFilter()
	local value
	if GAMESTATE:IsPlayerEnabled(PLAYER_1) then
...
local function GetUpperDifficultyFilter()
	local value
	if GAMESTATE:IsPlayerEnabled(PLAYER_1) then
...
local function GetLowerBPMFilter()
	local value
	if GAMESTATE:IsPlayerEnabled(PLAYER_1) then
...
local function GetUpperBPMFilter()
	local value
	if GAMESTATE:IsPlayerEnabled(PLAYER_1) then
...
local function GetLowerLengthFilter()
	local value
	if GAMESTATE:IsPlayerEnabled(PLAYER_1) then
...
local function GetUpperLengthFilter()
	local value
	if GAMESTATE:IsPlayerEnabled(PLAYER_1) then
