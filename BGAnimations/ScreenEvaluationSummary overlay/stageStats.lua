...
for pn in ivalues(Players) do
	...
	local difficultyMeter = playerStats:GetPlayedSteps()[1]:GetMeter();
	local difficulty = playerStats:GetPlayedSteps()[1]:GetDifficulty();
	local stepartist = playerStats:GetPlayedSteps()[1]:GetAuthorCredit()
