...
local t = Def.ActorFrame{
	CodeMessageCommand=function(self, param)
		if param.Name == "Screenshot" then
			...
			-- organize Screenshots taken using Digital Dance into directories, like...
			-- ./Screenshots/Digital Dance/2015/06-June/2015-06-05_121708.png
			local prefix = "Digital Dance/" .. Year() .. "/"
