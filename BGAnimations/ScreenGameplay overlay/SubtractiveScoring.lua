...
if SL[ToEnumShortString(player)].ActiveModifiers.SubtractiveScoring then
	...
	local fa_plus = (the_metrics.PercentScoreWeightW1 == the_metrics.PercentScoreWeightW2)
	local undesirable_judgment = fa_plus and "W3" or "W2"
	...
	return Def.BitmapText{
		...
		InitCommand=function(self)
			...
			:diffuse(color("#ee66ff")):zoom(0.35):shadowlength(1)
			:xy( x_position + GetNotefieldWidth() / 3.6, _screen.cy )
		end,
		...
		SetScoreCommand=function(self, params)
			...
			elseif (((fa_plus and tns ~= "W1" and tns ~= "W2") or (not fa_plus and tns ~= "W1")) and tns ~= "AvoidMine") or
