...
t[#t+1] = LoadFont("_wendy small")..{
	...
	RefreshCommand=function(self)
		...
		if screen then
			...
			if sClass == "ScreenGameplay" or sClass == "ScreenPlayerOptions" or sClass == "ScreenStageInformation" or sClass == "ScreenEvaluationStage" or sClass == "ScreenEvaluationCourse" or sClass == "ScreenEvaluationSummary" or sClass == "ScreenNameEntryActual" or sClass == "ScreenNameEntryTraditional" then
				bShow = false
			end
		end
