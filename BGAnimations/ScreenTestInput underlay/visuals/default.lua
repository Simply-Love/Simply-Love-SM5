...
t[#t+1] = Def.ActorFrame{
	...
	LoadActor(game..".png")..{
		InitCommand=cmd(xy,SCREEN_CENTER_X-150,SCREEN_CENTER_Y-80; zoom,0.8);
	};
	LoadActor("buttons.png")..{
		InitCommand=cmd(xy,SCREEN_CENTER_X-150,SCREEN_CENTER_Y+80; zoom,0.5);
	};
	...
	LoadActor("highlightarrow.png")..{
		InitCommand=cmd(xy,SCREEN_CENTER_X-187,SCREEN_CENTER_Y+80; rotationz,180; zoom, 0.5;);
		Player1MenuLeftOnMessageCommand=cmd(diffusealpha,1;);
		Player1MenuLeftOffMessageCommand=cmd(diffusealpha,0);
	};
	--menuright highlight
	LoadActor("highlightarrow.png")..{
		InitCommand=cmd(xy,SCREEN_CENTER_X-113,SCREEN_CENTER_Y+80; zoom, 0.5;);
	...
	LoadActor("highlightgreen.png")..{
		InitCommand=cmd(xy,SCREEN_CENTER_X-150,SCREEN_CENTER_Y+66; zoom, 0.5;);
	...
	LoadActor("highlightred.png")..{
		InitCommand=cmd(xy,SCREEN_CENTER_X-150,SCREEN_CENTER_Y+94.5;rotationz,180; zoom, 0.5;);
	...
	LoadActor("highlight.png")..{
		InitCommand=cmd(xy,SCREEN_CENTER_X-217,SCREEN_CENTER_Y-148; zoom, 0.8; );
		Player1UpLeftOnMessageCommand=cmd(diffusealpha,1;);
		Player1UpLeftOffMessageCommand=cmd(diffusealpha,0);
	};
	--up highlight
	LoadActor("highlight.png")..{
		InitCommand=cmd(xy,SCREEN_CENTER_X-150,SCREEN_CENTER_Y-148; zoom, 0.8; );
		Player1UpOnMessageCommand=cmd(diffusealpha,1;);
		Player1UpOffMessageCommand=cmd(diffusealpha,0);
	};
	--upright highlight
	LoadActor("highlight.png")..{
		InitCommand=cmd(xy,SCREEN_CENTER_X-83,SCREEN_CENTER_Y-148; zoom, 0.8; );
	...
	--left highlight
	LoadActor("highlight.png")..{
		InitCommand=cmd(xy,SCREEN_CENTER_X-217,SCREEN_CENTER_Y-80; zoom, 0.8; );
	...
	--right highlight
	LoadActor("highlight.png")..{
		InitCommand=cmd(xy,SCREEN_CENTER_X-83,SCREEN_CENTER_Y-80; zoom, 0.8; );
	...
	-- downleft highlight
	LoadActor("highlight.png")..{
		InitCommand=cmd(xy,SCREEN_CENTER_X-217,SCREEN_CENTER_Y-12; zoom, 0.8; );
		Player1DownLeftOnMessageCommand=cmd(diffusealpha,1);
		Player1DownLeftOffMessageCommand=cmd(diffusealpha,0);
	};
	-- down highlight
	LoadActor("highlight.png")..{
		InitCommand=cmd(xy,SCREEN_CENTER_X-150,SCREEN_CENTER_Y-12; zoom, 0.8; );
		Player1DownOnMessageCommand=cmd(diffusealpha,1);
		Player1DownOffMessageCommand=cmd(diffusealpha,0);
	};
	-- downright highlight
	LoadActor("highlight.png")..{
		InitCommand=cmd(xy,SCREEN_CENTER_X-83,SCREEN_CENTER_Y-12; zoom, 0.8; );
...
t[#t+1] = Def.ActorFrame{
	...
	--menuleft highlight
	LoadActor("highlightarrow.png")..{
		InitCommand=cmd(xy,SCREEN_CENTER_X+113,SCREEN_CENTER_Y+80;rotationz,180; zoom, 0.5);
		Player2MenuLeftOnMessageCommand=cmd(diffusealpha,1;);
		Player2MenuLeftOffMessageCommand=cmd(diffusealpha,0);
	};
	--menuright highlight
	LoadActor("highlightarrow.png")..{
		InitCommand=cmd(xy,SCREEN_CENTER_X+187,SCREEN_CENTER_Y+80; zoom, 0.5);
	...
	--select highlight
	LoadActor("highlightred.png")..{
		InitCommand=cmd(xy,SCREEN_CENTER_X+150,SCREEN_CENTER_Y+94.5; zoom, 0.5);
