return {
	...
	-- page 3
	{
		...
		},
		{
			...
			Img="GitHub.png",
			About="Many thanks go to andrewipark and Kauhsa for repeatedly submitting fantastic pull requests that fixed bugs, improved performance, and made my life easier.\n\nAdditional thanks go to OmnipotentEntity, ianklatzco, FishamanP, itg-abby, camsta4, fent, djjack, Flameshadowxeroshin, Horsey-, TheKamilia, tfrederick74656, DinsFire64, StefanoFiumara, dougshell, and shockdude.  Every little bit helps!"
		}
	},
