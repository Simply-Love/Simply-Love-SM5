...
af[#af+1] = LoadActor(THEME:GetPathB("ScreenHereInTheDarkness", "overlay/14/email.lua"), scene3)..{
	InitCommand=function(self)
		scenes[3] = self
		self:visible(false)
	end,
...
af[#af+1] = LoadActor( THEME:GetPathB("ScreenHereInTheDarkness", "overlay/14/email.lua"), scene4 )..{
	InitCommand=function(self)
		scenes[4] = self
		self:visible(false)
	end,
...
af[#af+1] = LoadActor(THEME:GetPathB("ScreenHereInTheDarkness", "overlay/14/im-window.lua"), scene5 )..{
	InitCommand=function(self)
		scenes[5] = self
		self:visible(false)
	end,
...
af[#af+1] = LoadActor( THEME:GetPathB("ScreenHereInTheDarkness", "overlay/16/stargazing.lua") )..{
	InitCommand=function(self)
		scenes[6] = self
