...
af[#af+1] = LoadActor(THEME:GetPathB("ScreenHereInTheDarkness", "overlay/17/Scene 1/default.lua"))..{
...
for i=2, #duration do
	af[#af+1] = LoadActor(THEME:GetPathB("ScreenHereInTheDarkness", "overlay/17/Scene ".. i .."/default.lua") )..{
