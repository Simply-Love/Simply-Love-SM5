...
local af = Def.ActorFrame{
	OnCommand=function(self)
		self:sleep(2):queuecommand("Appear")
			:sleep(5)
			:smooth(0.666):diffuse(0,0,0,1)
			:queuecommand("Hide")
	end,
...
af[#af+1] = LoadActor("./buzz.ogg")..{
	OnCommand=function(self) self:sleep(0.666):queuecommand("Play") end,
...
af[#af+1] = Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		AppearCommand=function(self) self:sleep(1.5):smooth(2):diffuse(1,1,1,1) end,
	...
	Def.ActorFrame{
		InitCommand=function(self) self:xy(_screen.cx, _screen.cy-60):diffuse(0,0,0,1) end,
		...
		Def.BitmapText{
			...
			InitCommand=function(self)
				self:zoom(0.8):align(0,0)
				self:x(-_phone.w/2 + 32)
				self:y(-36)
			end
		},
		-- message text
