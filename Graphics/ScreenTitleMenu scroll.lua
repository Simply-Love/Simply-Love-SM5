...
t[#t+1] = LoadFont("_wendy small")..{
	...
	GainFocusCommand=cmd(stoptweening; zoom,0.45; accelerate,0.15; diffuse, PlayerColor(PLAYER_2); glow,color("1,1,1,0.5");decelerate,0.05;glow,color("1,1,1,0.0")),
	LoseFocusCommand=cmd(stoptweening; zoom,0.35; accelerate,0.2; diffuse,color("#888888"); glow,color("1,1,1,0.0"))
